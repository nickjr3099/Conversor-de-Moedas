...
texto_moeda_destino = customtkinter.CTkLabel(janela, text="Selecione moeda de destino")
...
campo_moeda_origem = customtkinter.CTkOptionMenu(janela, values=list(dic_conversoes_disponiveis.keys()),
                                                 command=carregar_moeda_destino)
campo_moeda_destino = customtkinter.CTkOptionMenu(janela, values=["Selecione moeda de destino"])
...
for codigo_moeda in moeda_disponiveis:
    nome_moedas = moeda_disponiveis[codigo_moeda]
    texto_moeda = customtkinter.CTkLabel(lista_moedas, text=f"{codigo_moeda}: {nome_moedas}")
    texto_moeda.pack()
